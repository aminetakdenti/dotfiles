...
do
  ...
  -- Onyx Gold theme (local plugin)
  vim.opt.runtimepath:prepend(vim.fn.expand '~/my-theme/nvim-plugin')
  require('onyx-gold').setup { variant = 'dark' }
  vim.cmd.colorscheme 'onyx-gold'
...
do
  ...
  vim.api.nvim_create_autocmd('LspAttach', {
    ...
    callback = function(event)
      ...
      map('gd', vim.lsp.buf.definition, '[G]oto Code [D]efinition')
